...
<template>
  ...
  <div class="row section01">
    <div class="col-lg-6 col-md-12 left">
      <p>
        Fyodor Mikhailovich Dostoevsky(Russian: Фёдор Михайлович Достоевский; 11 November 1821 – 9 February 1881), sometimes transliterated as Dostoyevsky, was a Russian
        novelist, short story writer, essayist and journalist. Dostoevsky's literary works explore the human condition in the troubled political, social, and spiritual
        atmospheres of 19th-century Russia, and engage with a variety of philosophical and religious themes. His most acclaimed novels include Crime and Punishment
        (1866), The Idiot (1869), Demons (1872), and The Brothers Karamazov (1880).
      </p>
      <p>
        Dostoevsky's body of work consists of thirteen novels, three novellas, seventeen short stories, and numerous other works. His writings were widely read both
        within and beyond his native Russia and influenced an equally great number of later writers including Russians such as Aleksandr Solzhenitsyn and Anton Chekhov,
        philosophers Friedrich Nietzsche and Jean-Paul Sartre, and the emergence of Existentialism and Freudianism. His books have been translated into more than 170
        languages, and served as the inspiration for many films.
      </p>
    </div>
  ...
  <section class="section05" id="section05">
    ...
    <div class="entries">
      <div class="entry">
        ...
        <div class="body">
          <p>Born in Moscow on October 30 (November 11 according to the Gregorian Calendar).</p>
        </div>
      </div>
      <div class="entry">
        <div class="title">1838</div>
        <div class="body">
          <p>admitted to St. Petersburg Academy of Military Engineers as an army cadet.</p>
        </div>
      </div>
      <div class="entry">
        <div class="title">1846</div>
        <div class="body">
          <p>publication of 1st novel Poor Folk, The Double (appearing 2 weeks later), and Mr. Prokharchin.</p>
        </div>
      </div>
      <div class="entry">
        <div class="title">1849</div>
        <div class="body">
          <p>arrested for alleged political crimes along with other Petrashevsky Circle members servitude in Siberia.</p>
        </div>
      </div>
      <div class="entry">
        <div class="title">1866</div>
        <div class="body">
          <p>publishes “Crime and Punishment” and “The Gambler”.</p>
        </div>
      </div>
      <div class="entry">
        <div class="title">1879</div>
        <div class="body">
          <p>publishes first part of “The Brothers Karamazov”.</p>
        </div>
      </div>
      <div class="entry">
      ...
      <q-carousel
        ...
        <q-carousel-slide name="style" class="column no-wrap flex-center slide">
          ...
          <div class="q-mt-md text-center">
            <p class="comment">
              “Whoever you are, you are the vessel of this perplexed liquid, this cloudy, yeasty, precious stuff, the soul. The soul is not restrained by barriers. It
              overflows, it floods, it mingles with the souls of others.”
            </p>
          </div>
